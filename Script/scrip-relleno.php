...
for ($entradas = 0; $entradas < 100; $entradas++) {
    ...
    repositorio_entradas::insertar_entradas(conexion::obtener_conexion(), $entrada);
}
...
for ($comentarios = 0; $comentarios < 100; $comentarios++) {
    ...
    repositorio_comentario:: insertar_comentario(conexion::obtener_conexion(), $comentario);
}
